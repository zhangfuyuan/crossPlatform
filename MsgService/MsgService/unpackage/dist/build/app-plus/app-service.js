...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["common/main"],{"15f5":function(n,e,t){"use strict";Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var o={onLaunch:function(){console.log("App Launch"," at App.vue:4");var n,e,t,o=[],i=!1,a=!1,r=!1,u=function(n){plus?n():document.addEventListener("plusready",function(){n()},!1)},c=function(i){if("Android"===plus.os.name)try{var a=plus.runtime.innerVersion.split(".");r=parseInt(a[a.length-1])<22298,t=plus.android.runtimeMainActivity(),t.moveTaskToBack(!1);plus.android.importClass("android.content.Intent");var u=plus.android.importClass("android.content.IntentFilter"),c=plus.android.importClass("android.telephony.SmsMessage"),l="io.dcloud.feature.internal.reflect.BroadcastReceiver";r&&(l="io.dcloud.feature.internal.a.a"),e=new u;var d=function(n,e){try{var t=e.getAction();if("android.provider.Telephony.SMS_RECEIVED"==t){for(var i=e.getSerializableExtra("pdus"),a=[],r=0,u=i.length;r<u;r++)a.push(c.createFromPdu(i[r]));for(r=0,u=o.length;r<u;r++)o[r](a)}}catch(l){}};n=plus.android.implements(l,{a:d,onReceive:d}),e.addAction("android.provider.Telephony.SMS_RECEIVED"),i&&i()}catch(s){}},l=function(l){if(o.push(l),i){if(!a)try{r?t.a(n,e):t.registerReceiver(n,e)}catch(d){}}else i=a=!0,u(function(){c(function(){setTimeout(function(){try{r?t.a(n,e):t.registerReceiver(n,e)}catch(d){}},300)})})},d=function(n){n.length>0&&plus.nativeUI.toast(n[n.length-1].getDisplayMessageBody())};l(d)},onShow:function(){console.log("App Show"," at App.vue:163")},onHide:function(){console.log("App Hide"," at App.vue:166")}};e.default=o},"542c":function(n,e,t){"use strict";t.r(e);var o=t("15f5"),i=t.n(o);for(var a in o)"default"!==a&&function(n){t.d(e,n,function(){return o[n]})}(a);e["default"]=i.a},"57bf":function(n,e,t){"use strict";t.r(e);var o=t("542c");for(var i in o)"default"!==i&&function(n){t.d(e,n,function(){return o[n]})}(i);t("88df");var a,r,u=t("2877"),c=Object(u["a"])(o["default"],a,r,!1,null,null,null);e["default"]=c.exports},"88df":function(n,e,t){"use strict";var o=t("8e62"),i=t.n(o);i.a},"8e62":function(n,e,t){}},[["c600","common/runtime","common/vendor"]]]);
});
